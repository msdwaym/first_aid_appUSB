  ...
  <view class="contentBox">
    ...
    <view class="returnBtnBox">
      <view class="returnBtnCss">
        <view @click="navigate('/pages/materialUseRegistrationAuto/materialUseRegistrationAuto')">连续扫描</view>
      </view>
      <view class="returnBtnCss">
        <view @click="navigate('/pages/materialUseRegistration/index')">单件扫描</view>
      </view>
      <view class="returnBtnCss">
